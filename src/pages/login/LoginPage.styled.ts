...
export const NoticeText = styled.div<{ $isError?: boolean }>`
  color: ${({ theme, $isError }) =>
    $isError ? theme.colors.Orange01 : theme.colors.Black01};
  ${({ theme, $isError }) =>
    $isError ? theme.fonts.SemiBold14 : theme.fonts.SemiBold12};
  margin-top: 10px;
  margin-bottom: 43px;
